...
@protocol LeftSlideViewDelegate <NSObject>

- (void)OpenCompeleteAnimation;
- (void)CloseCompeleteAnimation;
@end
...
//自己添加的代理
@property (weak, nonatomic) id <LeftSlideViewDelegate> delegate;
...
//(UITabBarController *)andMainView
