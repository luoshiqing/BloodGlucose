...
- (void)setupTitleBar {
    ...
    [leftButton setImage:[UIImage imageNamed:@"RJT.png"] forState:UIControlStateNormal];
    ...
    [rightButton setImage:[UIImage imageNamed:@"LJT.png"] forState:UIControlStateNormal];
    ...
    titleButton.titleLabel.tintColor = [UIColor redColor];
    titleButton.tintColor = [UIColor redColor];
